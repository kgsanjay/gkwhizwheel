...
test('cancellation refund successfully processes via phonepe api', function (): void {
    Http::fake([
        'api-preprod.phonepe.com/apis/pg-sandbox/pg/v1/refund' => Http::response([
            'success' => true,
            'code' => 'PAYMENT_SUCCESS',
            'message' => 'Refund successful',
            'data' => [
                'transactionId' => 'rfnd_phonepe_001',
                'amount' => 100000,
                'state' => 'COMPLETED',
            ],
        ], 200),
    ...
    $payment = Payment::create([
        ...
        'gateway_reference' => 'pay_phonepe_123',
        'amount' => 1000.00,
        'type' => 'advance',
    ]);
    ...
    expect($refund->status)->toBe(RefundStatus::COMPLETED)
        ->and($refund->gateway_reference)->toBe('rfnd_phonepe_001')
